...
spider，参考\ `官方文档 <http://doc.scrapy.org/en/1.0/topics/practices.html#run-scrapy-from-a-script>`__

脚本运行Scrapy
~~~~~~~~~~~~~~

可以利用scrapy提供的\ `核心API <http://doc.scrapy.org/en/1.0/topics/api.html#topics-api>`__\ 通过编程方式启动scrapy，代替传统的\ ``scrapy crawl``\ 启动方式。

Scrapy构建于Twisted异步网络框架基础之上，因此你需要在Twisted
reactor里面运行。
...
你可以在\ `GitHub <https://github.com/yidao620c/core-scrapy>`__\ 上看到本文的完整项目源码。
